...
| 🖋️ [`font-faces/all.css`](../dist/source/font-faces/all.css) | Every `@font-face` decl. for the typography classes, adapted from [dotcom-rendering](https://github.com/guardian/dotcom-rendering/blob/main/dotcom-rendering/src/lib/fonts-css.ts) | [Source: Typography presets](https://zeroheight.com/2a1e5182b/p/01555f-typography-presets) |
| 🖋️ [`font-faces/titlepiece.css`](../dist/source/font-faces/titlepiece.css) | `@font-face` decls. for `GT Guardian Titlepiece` only (uncommon, so not usually already loaded) | [Source: Typography presets](https://zeroheight.com/2a1e5182b/p/01555f-typography-presets) |
| 🖋️ [`font-faces/headline.css`](../dist/source/font-faces/headline.css) | `@font-face` decls. for `GH Guardian Headline` (and legacy `Guardian Egyptian Web`) only | [Source: Typography presets](https://zeroheight.com/2a1e5182b/p/01555f-typography-presets) |
| 🖋️ [`font-faces/text-egyptian.css`](../dist/source/font-faces/text-egyptian.css) | `@font-face` decls. for `GuardianTextEgyptian` (and legacy `Guardian Text Egyptian Web`) only | [Source: Typography presets](https://zeroheight.com/2a1e5182b/p/01555f-typography-presets) |
| 🖋️ [`font-faces/text-sans.css`](../dist/source/font-faces/text-sans.css) | `@font-face` decls. for `GuardianTextSans` (and legacy `Guardian Text Sans Web`) only | [Source: Typography presets](https://zeroheight.com/2a1e5182b/p/01555f-typography-presets) |
| 🖋️ [`font-faces/headline-numeric.css`](../dist/source/font-faces/headline-numeric.css) | `@font-face` overrides for `GH Guardian Headline` with OpenType numeric features (tabular figures, fractions, super/subscripts); import after `headline.css` | |
